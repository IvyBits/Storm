package com.github.Icyene.Storm.Snow.ThruBlocks;
...
public class SnowThroughBlocks extends JavaPlugin implements Listener
{
    ...
    {
	passThru = Arrays
		.asList(GlobalVariables.Snow_PassThruBlocks_Block__IDS__To__Pass__Through);
    }
	...
	{
	    if (MultiWorldManager.checkWorld(world, GlobalVariables.Snow_PassThruBlocks_Allowed__Worlds)) {
	...
	if (!MultiWorldManager.checkWorld(event.getWorld(),
		GlobalVariables.Snow_PassThruBlocks_Allowed__Worlds)) {	
	    return;
	}
