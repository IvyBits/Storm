...
public class EntityMeteor extends EntityFireball {
	...
	public boolean isSpawnOnImpact() {
		return spawnMeteorOnImpact;
	}

	public void setSpawnOnImpact(boolean spawnMeteorOnImpact) {
		this.spawnMeteorOnImpact = spawnMeteorOnImpact;
	}
